 ...
 */
  public final class Constants {
    ...
    public static final double FRONT_LEFT_STEER_OFFSET = -Math.toRadians(127.0); // FIXM E Measure and set
    // front
    // left steer offset
    ...
    public static final double FRONT_RIGHT_STEER_OFFSET = -Math.toRadians(77.0); // FIXM E Measure and set
    // front
    // right steer offset
    ...
    public static final double BACK_LEFT_STEER_OFFSET = -Math.toRadians(234.0); // FIXM E Measure and set
    // back
    // left steer offset
    ...
    public static final double BACK_RIGHT_STEER_OFFSET = -Math.toRadians(97.1); // FIXM E Measure and set
    // back
    // right steer offset
    ...
    public static final SparkPIDConfig TURN_MOTOR_CONFIG = null;

    public static final TalonPIDConfig DRIVE_MOTOR_CONFIG = null;
