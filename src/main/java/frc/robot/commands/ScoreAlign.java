...
public class ScoreAlign extends CommandBase {
  ...
  public ScoreAlign(DriveSubsystem driveSubsystem, PoseEstimatorSubsytem poseestimator) {
  ...
  public void initialize() {
    ...
    final double angle = m_poseEstimator.getCurrentPose().getRotation().getDegrees() + 180;
  ...
  public void execute() {
    ...
    System.out.println(m_poseEstimator.getCurrentPose().getRotation().getDegrees() + 180);

    m_driveSubsystem.drive(0, 0, rotationRate, true);

    System.out.println("rotation from pose: " + (m_poseEstimator.getCurrentPose().getRotation().getDegrees() + 180));
