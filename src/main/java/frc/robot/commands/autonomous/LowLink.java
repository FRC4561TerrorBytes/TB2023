...
public class LowLink {
   ...
   */
  public LowLink(DriveSubsystem driveSubsystem, String autoPathName, double maxSpeedMetersPerSec,
    ...
    m_eventMap.put("testMarker", new InstantCommand(() -> System.out.print("HIT THE MARKER WOOOOOHOOOOOOO\n\n\n\n")));
  ...
  FollowPathWithEvents armMoveCommand = new FollowPathWithEvents(m_swerveControllerCommand, m_pathPlannerTrajectory.getMarkers(), m_eventMap);

  public Command getCommandAndStop() {
    return new InstantCommand(() -> resetOdometry(), m_driveSubsystem).andThen(new FollowPathWithEvents(armMoveCommand, m_pathPlannerTrajectory.getMarkers(), m_eventMap))
