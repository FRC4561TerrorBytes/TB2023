...
public class ScoreCubeStop extends SequentialCommandGroup {
  /** Creates a new ScoreCube. */
  public ScoreCubeStop(DriveSubsystem m_driveSubsystem, ArmSubsystem m_armSubsystem, IntakeSubsystem m_intakeSubsystem) {
