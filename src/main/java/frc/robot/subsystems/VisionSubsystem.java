...
public class VisionSubsystem extends SubsystemBase {
  ...
  private void centerAprilTag(final double aprilTagOffset, final double backOffset) {
    ...
    if (targetTransform != null) {
      ...
      m_driveSubsystem.drive(xSpeed * 1.2, (ySpeed) * Constants.VISION_LATERAL_SCALING,
  ...
  public void periodic() {
    SmartDashboard.putBoolean("Has target", hasTarget(rightCamera.getLatestResult()) || hasTarget(leftCamera.getLatestResult()));
  }
